 ...
 * This is not a class myself (kelmore5) created, but I used it as a reference on how to properly
 * implement a JLayeredPane as well as commented it myself. It displays five different panels for
 * the JLayeredPane, allows the user to chose which pane he wants displayed, and brings that one
 * to the front of the stack. The interface is demonstrated with a black square where the mouse is.
 * </pre>
 *
 * @author anon
...
public class LayeredPaneDemo extends JPanel implements ActionListener, MouseMotionListener {
    /**
     * String array for the names of the different panels
     */
    ...
    /**
     * Colors for the different panels
     */
    ...
    /**
     * Label for the panel selector
     */
    private JLabel dukeLabel;
    /**
     * Checkbox to define whether you want the panel selected to be on top or bottom of the mouse identifier
     */
    private JCheckBox onTop;
    /**
     * ComboBox to select which panel to bring to the front of the JLayeredPane
     */
    ...
    private static ImageIcon createImageIcon(@SuppressWarnings("SameParameterValue") String path)
    {
