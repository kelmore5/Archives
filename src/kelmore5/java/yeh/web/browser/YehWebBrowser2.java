package kelmore5.java.yeh.web.browser;
 ...
 * @custom.date 3/18/17
 */
public class YehWebBrowser2 extends JFrame
{
    /**
     *
     */
    ...
    public YehWebBrowser2() throws IOException
    {
    ...
    private class WebBrowserTabs extends JTabbedPane
    {
        /**
         *
         */
    ...
    private class WebBrowserPane extends JEditorPane
    {
        /**
         *
         */
    ...
    private class WebToolBar extends JToolBar implements HyperlinkListener
    {
        /**
         *
         */
    ...
    public Boolean checkBookmark(GetURL grl)
    {
        Boolean bool = false;
    ...
    {
        YehWebBrowser2 browser = new YehWebBrowser2();
